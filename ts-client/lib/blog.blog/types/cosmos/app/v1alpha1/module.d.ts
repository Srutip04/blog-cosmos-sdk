...
export declare const ModuleDescriptor: {
    ...
    } & { [K_4 in Exclude<keyof I, keyof ModuleDescriptor>]: never; }>(base?: I): ModuleDescriptor;
    fromPartial<I_1 extends {
        ...
        usePackage?: {
            ...
            name?: string;
            revision?: number;
        } & { [K_5 in Exclude<keyof I_1["usePackage"][number], keyof PackageReference>]: never; })[] & { [K_6 in Exclude<keyof I_1["usePackage"], keyof {
            name?: string;
            revision?: number;
        }[]>]: never; };
        canMigrateFrom?: {
            ...
            module?: string;
        } & { [K_7 in Exclude<keyof I_1["canMigrateFrom"][number], "module">]: never; })[] & { [K_8 in Exclude<keyof I_1["canMigrateFrom"], keyof {
            module?: string;
        }[]>]: never; };
